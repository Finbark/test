...
import pylab as pl
import numpy as np
import fitness as fF

class ga:
    '''
    Genetic algorithm, modified from the original code to not perform crossover. 
    '''

    def __init__(self,stringLength,fitnessFunction,nEpochs,populationSize=100,mutationProb=-1,nElite=4,tournament=True):
        """ Constructor"""
